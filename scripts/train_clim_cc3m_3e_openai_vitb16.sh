torchrun --nproc_per_node 8 -m training.main --batch-size=128 --lr=1e-5 --wd=0.1 --epochs=3 --workers=4 \
...
--lock-image --save-frequency 3 --lock-image-unlocked-groups 12 --extract-type="v2" \
--name clim_cc3m_3_save3_test1_openai_vitb16_12layers --downsample-factor 16 --det-image-size 1024 \
