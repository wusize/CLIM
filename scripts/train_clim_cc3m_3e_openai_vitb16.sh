torchrun --nproc_per_node 4 -m training.main --batch-size=32 --lr=1e-5 --wd=0.1 --epochs=3 --workers=4 \
...
--embed-path metadata/coco_panoptic_clip_hand_craft_ViTB16.npy --train-image-root="data/cc3m" \
